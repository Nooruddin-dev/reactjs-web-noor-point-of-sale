...
import {  getInvnetoryMethodsListApi, getPaymentMethodsListApi, getUserTypesListApi } from '../../../../../_poscommon/common/helpers/api_helpers/ApiCalls'
...
export default function AdminUserTypesPage() {
    ...
    const getUserTypesListService = () => {
        ...
        getUserTypesListApi(pageBasicInfoParams)
            .then((res: any) => {
                const { data } = res;
                            ...
                            >
                                <thead>
                                    <tr className='text-start text-muted fw-bolder fs-7 gs-0 bg-light'>
                                        <th colSpan={1} role="columnheader" className="min-w-125px ps-3 rounded-start" style={{ cursor: 'pointer' }}>User Type Id</th>
