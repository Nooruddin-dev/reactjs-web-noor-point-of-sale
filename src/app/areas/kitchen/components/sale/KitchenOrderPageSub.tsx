...
import CashierPageHeader from '../layout/KitchenPageHeader'
...
import { orderStatusesConst, orderTypesConst } from '../../../../../_poscommon/common/enums/GlobalEnums'
...
import { faClock, faPager, faPrint } from '@fortawesome/free-solid-svg-icons'
...
export default function KitchenOrderPageSub(props: { customerId: number }) {
                                            ...
                                            allOrders?.map((record: any) => (
                                                <tr>
                                                    ...
                                                    <td className='text-end pe-3'>
                                                        ...
                                                        <Link
                                                            to={`/kitchen/order-detail/${record.orderId}`}
                                                            className='btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4 me-2'
                                                        >
