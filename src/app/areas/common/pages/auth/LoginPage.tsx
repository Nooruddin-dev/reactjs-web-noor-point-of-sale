            ...
            .then((res: any) => {
                if (res?.data) {
                    ...
                    if (user != undefined && user != null) {
                        ...
                        setTimeout(() => {
                            if (user?.busnPartnerTypeId == BusinessPartnerTypesEnum.Admin) {
                            ...
                            } else if (user?.busnPartnerTypeId == BusinessPartnerTypesEnum.Cashier) {
                                //navigate('/cashier/dashboard');
                                window.location.href = '/cashier/dashboard';
                            } else if (user?.busnPartnerTypeId == BusinessPartnerTypesEnum.Customer && user?.isWalkThroughCustomer == true) {
                                // navigate('/visitor/pos-main');
                                window.location.href = '/visitor/pos-main';
                            } else if (user?.busnPartnerTypeId == BusinessPartnerTypesEnum.KitchenStaff) {
                ...
                <div className="d-flex flex-column flex-column-fluid flex-lg-row">
                    ...
                    <div className="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                        <div className="d-flex flex-center flex-lg-start flex-column">
                            ...
                            {/* Title */}
                            <h2 className="text-white fw-normal m-0">Efficient POS Solutions Tailored to Your Business</h2>
                        </div>
                    </div>
                    {/* Body */}
