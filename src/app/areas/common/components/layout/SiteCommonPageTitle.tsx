...
import { useLayout } from '../../../../../_poscommon/admin/layout/core';



interface SiteCommonPageTitleProps {
    title: string;
    pageDescription: string;
  }
const SiteCommonPageTitle: React.FC<SiteCommonPageTitleProps> = ({ title, pageDescription }) => {
...
export default SiteCommonPageTitle;