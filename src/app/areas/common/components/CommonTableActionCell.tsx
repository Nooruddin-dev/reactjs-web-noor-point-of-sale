...
import { MenuComponent } from '../../../../_poscommon/admin/assets/ts/components'
import { ID, KTIcon } from '../../../../_poscommon/admin/helpers'
...
import { deletAnyRecordApi } from '../../../../_poscommon/common/helpers/api_helpers/ApiCalls'
