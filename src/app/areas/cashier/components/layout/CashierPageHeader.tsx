...
import { ILayout, useLayout } from '../../../../../_poscommon/admin/layout/core';
import { ToolbarClassic } from '../../../../../_poscommon/admin/layout/components/toolbar/toolbars';
import SiteCommonPageTitle from '../../../common/components/layout/SiteCommonPageTitle';
...
const CashierPageHeader: React.FC<CashierPageHeaderProps> = ({ title, pageDescription, addNewClickType, newLink, onAddNewClick, additionalInfo }) => {
