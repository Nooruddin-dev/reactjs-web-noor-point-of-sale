...
import { ToggleComponent } from '../../../../admin/assets/ts/components'
import { KTIcon, toAbsoluteUrl } from '../../../../admin/helpers'
...
const SidebarLogoVisitor = (props: PropsType) => {
  ...
  return (
    <div className='app-sidebar-logo pt-1 justify-content-center align-items-center' id='kt_app_sidebar_logo'>
      <Link to='/dashboard' className='me-2'>
        {config.layoutType === 'dark-sidebar' ? (
          <img
            alt='Logo'
            src={toAbsoluteUrl('media/logos/demo6.svg')}
            className=' app-sidebar-logo-default' style={{width:'97%', height:'40px'}}
          />
        ) : (
          <>
            <img
