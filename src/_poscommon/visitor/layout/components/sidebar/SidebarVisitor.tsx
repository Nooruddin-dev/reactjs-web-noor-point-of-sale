...
import { ILayout, useLayout } from '../../../../admin/layout/core'
import { SidebarMenuVisitor } from './sidebar-menu/SidebarMenuVisitor'
import { SidebarLogoVisitor } from './SidebarLogoVisitor'
    ...
    <>
      {(config.layoutType === 'dark-sidebar' || config.layoutType === 'light-sidebar') && (
        <div
          ...
          id='kt_app_sidebar'
          className={clsx('app-sidebar visitor-nav-sidebar', config.app?.sidebar?.default?.class)}
        >
          <SidebarLogoVisitor sidebarRef={sidebarRef} />
          <SidebarMenuVisitor />
          {/* <SidebarFooter /> */}
        </div>
      )}
